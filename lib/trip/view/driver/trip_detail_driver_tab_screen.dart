...
import 'package:tago_app/trip/view/driver/trip_detail_map_driver_screen.dart';
import 'package:tago_app/trip/view/driver/trip_detail_overview_driver_screen.dart';

class TripDetailDriverTabScreen extends ConsumerStatefulWidget {
  static String get routeName => 'tripDetailTabDriver';

  const TripDetailDriverTabScreen({super.key});

  @override
  ConsumerState<TripDetailDriverTabScreen> createState() =>
      _TripDetailDriverTabScreenState();
}

class _TripDetailDriverTabScreenState
    extends ConsumerState<TripDetailDriverTabScreen>
  ...
  void didChangeDependencies() {
    ...
    ref.read(tripDetailProvider.notifier).fetchDetailTrip(tripId, "DRIVER");
  }
  ...
  Widget build(BuildContext context) {
    ...
    final detailModel = tripDetailState as TripDetailDriverModel;
          ...
          children: <Widget>[
            ...
            Expanded(
              child: TabBarView(
                controller: _tabController,
                children: [
                  TripDetailOverviewDriverScreen(
                      detailModel: detailModel,
                      tripId: tripId,
                      tripStatus: tripStatus),
                  TripDetailMapDriverScreen(
                    detailModel: detailModel,
                  ),
                ],
              ),
